...
statesLayer.queryFeatures(query)
  ...
  var totalpopUrl = "https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services/ACS_Total_Population_Boundaries/FeatureServer/0"
...
var loadAdditionalData =function(){
  ...
  let additionalQuery = popLayer.createQuery();
  additionalQuery.returnGeometry = false;
  additionalQuery.outFields = "*"
  ////execute query on your new layer
 popLayer.queryFeatures(additionalQuery).then(function(r){
console.log(r)
